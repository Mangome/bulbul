...
|---|---|---|
| Context | The PRODUCT.md / DESIGN.md loader result is known from `node .codebuddy/skills/impeccable/scripts/load-context.mjs`. | Run the loader before continuing. |
...
```bash
node .codebuddy/skills/impeccable/scripts/load-context.mjs
```
